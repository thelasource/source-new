...
<div id="top-bar" class="topbar">
	...
	<div id="topbar-left" class="topbar-left">
		...
		<span class="topbar-language"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">ENGLISH</a></span> &middot; <span class="topbar-edition"><a class='expand-archive'><?php echo $edition_name; ?></a> &middot; <a class="pdf-download" href=<?php echo new_source_get_pdf('English') ?> ><i class="icon-download"></i> Download PDF </a></span>
